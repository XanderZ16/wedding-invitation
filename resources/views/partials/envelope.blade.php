<div id="envelope"
    ...
    <h1 class="mb-4 text-4xl text-white font-montecarlo">Wedding Invitation</h1>
    <h1 class="mb-4 text-4xl text-white font-fraunces">{{ $nick_groom }} & {{ $nick_bride }}</h1>
    <h2 class="mb-4 text-3xl text-white font-montecarlo">Kepada YTH :</h2>
    <h2 class="mb-8 text-xl font-light text-white font-fraunces sm:mb-2">
        @if ($guest)
            {{ $guest }}
        @else
            Bapak/Ibu Keluarga
    ...
    <button id="playButton"
        class="relative z-50 px-6 py-3 text-2xl text-white bg-black rounded-2xl font-jost sm:text-lg sm:px-4 sm:py-2">Open
        Invitation</button>
</div>
...
<button id="muteButton" class="fixed z-30 p-2 bottom-4 left-4">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" id="pause" class="hidden fill-white size-6">
        <path
